...
#def carga():
    # URL de la API de la plataforma en línea
    #url = "https://cp.ubiar.com/web?#page=0&limit=80&view_type=list&model=ticket.balanza&menu_id=1328&action=1069"

    # Ruta de acceso al archivo Excel
    #archivo_excel = "C:\\Users\\llopez\\OneDrive - Frigorífico Alberdi S.A\\Escritorio\\categorias\\90CUPO.xlsx"

    #try:
        # Realiza la solicitud POST con el archivo
    #    with open(archivo_excel, 'rb') as archivo:
    #        files = {'file': (archivo_excel, archivo)}
...
#def carga():
    # URL de la API de la plataforma en línea
 #   url = "https://cp.ubiar.com/web/action/load"

    # Encabezados de la solicitud POST
  #  headers = {
   #     "Host": "cp.ubiar.com",
    #    "Cookie": "session_id=88add8c138ab96dca85f0ba27bedd51fd207e456",
     #   "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/117.0",
     ##   "Accept": "application/json, text/javascript, */*; q=0.01",
     #   "Accept-Language": "es-AR,es;q=0.8,en-US;q=0.5,en;q=0.3",
     #   "Accept-Encoding": "gzip, deflate, br",
     #   "Content-Type": "multipart/form-data",  # Usamos 'multipart/form-data' para la carga de archivos
     #   "X-Requested-With": "XMLHttpRequest",
     #   "Origin": "https://cp.ubiar.com",
     #   "Referer": "https://cp.ubiar.com/web",
    ...
    # Abre y carga el archivo '90CUPO.xlsx'
    #with open('90CUPO.xlsx', 'rb') as file:
        # Creamos un diccionario de archivos para incluir el archivo '90CUPO.xlsx'
    #    files = {'file': ('90CUPO.xlsx', file)}

        # Realiza la solicitud POST con los encabezados, parámetros y archivos
     #   response = requests.post(url, headers=headers, data=params, files=files)

        # Procesar la respuesta
      #  if response.status_code == 200:
      #      print("El archivo '90CUPO.xlsx' se ha cargado exitosamente.")
      #  else:
      #      print(f"Error al cargar el archivo. Código de estado: {response.status_code}")
